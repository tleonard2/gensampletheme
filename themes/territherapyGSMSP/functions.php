...
function site_header_banner() {
	...
	echo '<div class="site-header-banner"><img src="' . get_stylesheet_directory_uri() . '/images/homebanner.jpg" alt="Counseling for Adults &amp; Couples" /></div>';

if ( ! is_front_page() && !is_archive() && !is_page_template('page_blog-php') || $post->post_parent )

		echo '<div class="site-header-banner"><img src="' . get_stylesheet_directory_uri() . '/images/gray-bokeh-2000x156px.jpg" alt="Counseling for Adults &amp; Couples" /></div>';
}
