...
add_action( 'genesis_before_header', 'beautiful_site_header_banner' );
function beautiful_site_header_banner() {

	if ( ! get_background_image() )
		return;

	echo '<div class="site-header-banner"><img src="' . get_stylesheet_directory_uri() . '/images/dorothybanner.png" /></div>';
...
add_filter( 'genesis_footer_creds_text', 'my_custom_footer_creds_text');
	function my_custom_footer_creds_text() {

		$creds = '<p>[footer_copyright]  Next Chapter New Life</p><p>Site by <a href="http://fiddleface.com" target="_blank">FiddleFace Web Design</a><p>';
		return $creds;
	}
